            ...
            <form action="<?= url('search-projects/') ?>" method="post">
                ...
                <div class="search-box-content mt-5 shadow-lg">
                    ...
                    <select class="form-select" aria-label="Default select example" name="price">
                        ...
                        <option value="500000">500000 تومان</option>
                    </select>
                    <i class="fa fa-dollar text-muted"></i>
                </div> -->
                    <!--                 
                <div class="w-100  d-flex align-items-center ps-2">
                    <select class="form-select" aria-label="Default select example" name="skils">
...
<section class="list-projects mt-5">
    <div class="container">
        <?php
        ?>
        <?php if (empty($request['name']) && empty($request['price'])) {
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="btn-projects ">
                                ...
                                <?php } else if ($project['status'] == 3) { ?>
                                    <a href="#" class="disabled">کارفرما فریلنسر استخدام کرده است</a>
