        ...
        <div class="col-xl-10 col-md-8 col-lg-8 me-auto mt-5">
            ...
            <div class="container">
                ...
                <div class=" mt-5 bg-white p-3 rounded-3">
                    ...
                    <?php                      } ?>
                    <form action="<?= url('panel/work-experience/store') ?>" method="post">
                        <h3 class="my-4 text-center">سوابق کاری </h3>
                                ...
                                <div class="d-flex align-items-center gap-2 mb-3">
                                    ...
                                    <div class="form-floating w-100">
                                        <input type="text" class="form-control" id="job"
                                            placeholder="سمت" name="job">
                                        <label for="job">سمت</label>
                                    </div>
                                    <div class="form-floating w-100">
                                        <input type="text" class="form-control" id="compony_name"
                                            placeholder="شرکت" name="compony_name">
                                        <label for="compony_name">شرکت</label>
                                    </div>
                                </div>
                                <div class="mb-3">
